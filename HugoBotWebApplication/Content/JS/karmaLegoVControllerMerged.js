...
myApp.controller('KarmalegoVcontrollerMerged', ['$scope', '$http', function ($scope, $http) {
    vm = this;
    vm.metadata = [];
    ...
    vm.getRootElements = function (stateID) {
        ...
        $http.post('/KarmaLegoV/getSubTree', fd, {
            ...
            for (i = 0; i < vm.numOfNextState; i++) {
                var localHorzTempVar = 0;
                var localHorzTempVar_2 = 0;
                if (vm.nextElementsList[i].VerticalSupport != 0) {
                    localHorzTempVar = vm.nextElementsList[i].HorizontalSupport / vm.nextElementsList[i].VerticalSupport;
                }

                if (vm.nextElementsList[i].vertSupp_2 != 0) {
                    localHorzTempVar_2 = vm.nextElementsList[i].horzSupp_2 / vm.nextElementsList[i].vertSupp_2;
                }
                ...
                vm.nextLevelStatesNames.push({
                    ...
                    "localHorz": localHorzTempVar,
                    "meanDuration": vm.nextElementsList[i].meanDuration,

                    "vertical_2": vm.nextElementsList[i].vertSupp_2,
                    "localHorz_2": localHorzTempVar_2,
                    "globalHorz_2": vm.nextElementsList[i].horzSupp_2 / vm.metadata.datEntities.length,
                    "meanDuration_2": vm.nextElementsList[i].meanDuration_2
    ...
    vm.fillCurrentLevelTable = function () {
        ...
        for (i = 0; i < vm.currentNumOfStates; i++) {
            var localHorzTempVar = 0;
            var localHorzTempVar_2 = 0;
            if (vm.currentElementsList[i].VerticalSupport != 0) {
                localHorzTempVar = vm.currentElementsList[i].HorizontalSupport / vm.currentElementsList[i].VerticalSupport;
            }

            if (vm.currentElementsList[i].vertSupp_2 != 0) {
                localHorzTempVar_2 = vm.currentElementsList[i].horzSupp_2 / vm.currentElementsList[i].vertSupp_2;
            }
            vm.currentStatesNames.push({
                ...
                "meanDuration": vm.currentElementsList[i].meanDuration,

                "vertical_2": vm.currentElementsList[i].vertSupp_2,
                "localHorz_2": localHorzTempVar_2,
                "globalHorz_2": vm.currentElementsList[i].horzSupp_2 / vm.metadata.datEntities.length,
                "meanDuration_2": vm.currentElementsList[i].meanDuration_2
